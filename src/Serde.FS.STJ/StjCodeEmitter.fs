...
type StjCodeEmitter() =
    ...
    static let writerCallForType (fieldName: string) (normalizedType: string) (valueExpr: string) (indent: string) : string =
    ...
    static let writerCall (fieldName: string) (fsharpType: string) : string =
